...
const char ssid[] = "comhem_3943DB";        // your network SSID (name)
const char pass[] = "xxxx";    // your network password (use for WPA, or use as key for WEP)
...
char buffer[30];
sprintf(buffer, "Time: %04d-%02d-%02d\n", now->tm_year + 1900, now->tm_mon + 1, now->tm_mday);
buffer[strlen(buffer) - 1] = '\0';  // overwrite the last \n with a null terminator
client.print(buffer);
...
void setup() {
  ...
  set_time(1683300000);  // Set RTC time to 5 May 2023
